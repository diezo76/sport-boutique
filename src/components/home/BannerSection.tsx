...
export default function BannerSection() {
  return (
    <section className="py-6 sm:py-10 bg-v-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8 sm:p-10">
              <h3 className="font-display text-3xl sm:text-4xl text-white uppercase tracking-wide mb-3 leading-tight">
              ...
              >
                <span className="w-9 h-9 rounded-full bg-v-black text-v-white flex items-center justify-center">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8 sm:p-10">
              ...
              >
                <span className="w-9 h-9 rounded-full border border-white/30 text-white flex items-center justify-center">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                  </svg>
                </span>
                <span className="font-medium text-sm">Shop collections</span>
              </Link>
            </div>
          </motion.div>
        </div>
